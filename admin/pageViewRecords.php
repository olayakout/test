				...
				<table class="table">
					...
					<tr>
						<td align="center">
							...
							<?php
								$arrFields = array('', 'customers', 'employees', 'orders', 'order_details', 'products', 'categories', 'suppliers', 'shippers', 'logs', 'test');
								$arrFieldCaptions = array('All tables', 'Customers', 'Employees', 'Orders', 'Order Items', 'Products', 'Product Categories', 'Suppliers', 'Shippers', 'Logs', 'Test');
