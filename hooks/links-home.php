...
$order_count=sqlValue("select count(*) from orders;");
?>
<script>
$j(function(){
$j('a.btn[href="orders_view.php"]').html('<img src="resources/table_icons/cash_register.png"> <strong>Orders (</strong><?php echo $order_count; ?>)');
});
</script>
