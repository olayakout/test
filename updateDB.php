<?php
	...
	if($thisMD5==$prevMD5){
		...
		setupTable('logs', "create table if not exists `logs` (   `id` INT unsigned not null auto_increment , primary key (`id`), `ip` VARCHAR(16) , `ts` BIGINT , `details` TEXT ) CHARSET latin1", $silent, array( "ALTER TABLE `table9` RENAME `logs`","UPDATE `membership_userrecords` SET `tableName`='logs' where `tableName`='table9'","UPDATE `membership_userpermissions` SET `tableName`='logs' where `tableName`='table9'","UPDATE `membership_grouppermissions` SET `tableName`='logs' where `tableName`='table9'","ALTER TABLE logs ADD `field1` VARCHAR(40)","ALTER TABLE `logs` CHANGE `field1` `id` VARCHAR(40) ","ALTER TABLE `logs` CHANGE `id` `id` INT unsigned not null auto_increment ","ALTER TABLE logs ADD `field2` VARCHAR(40)","ALTER TABLE `logs` CHANGE `field2` `ip` VARCHAR(40) "," ALTER TABLE `logs` CHANGE `ip` `ip` VARCHAR(16) ","ALTER TABLE logs ADD `field3` VARCHAR(40)","ALTER TABLE `logs` CHANGE `field3` `ts` VARCHAR(40) "," ALTER TABLE `logs` CHANGE `ts` `ts` BIGINT ","ALTER TABLE logs ADD `field4` VARCHAR(40)","ALTER TABLE `logs` CHANGE `field4` `details` VARCHAR(40) ","ALTER TABLE `logs` CHANGE `comments` `comments` TEXT "));
